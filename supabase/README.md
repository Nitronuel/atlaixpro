...
The current schema files support Live Alpha Feed discovered tokens, Detection Engine events, Token Impact Timeline events, Smart Money scanner jobs, and qualified wallet records.
